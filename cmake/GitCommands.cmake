...
function(get_git_dir DIRECTORY OUTPUT_VAR)
    execute_process(
        ...
        OUTPUT_VARIABLE GIT_DIR_OUTPUT
        ERROR_QUIET
...
function(get_git_current_hash DIRECTORY OUTPUT_VAR)
    execute_process(
        ...
        WORKING_DIRECTORY ${DIRECTORY}
        RESULT_VARIABLE GIT_CURRENT_HASH_RESULT
        OUTPUT_VARIABLE GIT_CURRENT_HASH_OUTPUT
        OUTPUT_STRIP_TRAILING_WHITESPACE
    )
...
function(run_git_submodule_foreach CMD DIRECTORY OUTPUT_VALUE)
    execute_process(
        COMMAND ${GIT_EXECUTABLE} submodule foreach --quiet --recursive "${CMD}"
    ...
    if(NOT ("${GIT_SUBMODULE_CMD_RESULT}" STREQUAL "0"))
        ...
        message(
            FATAL_ERROR
            "Failed to run git submodule foreach command: ${CMD} in ${DIRECTORY}"
        )
    endif()
